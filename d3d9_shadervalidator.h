...
// Note that the individual enum element names are not official and were generated by me, however their index and the string that follows are both official.
